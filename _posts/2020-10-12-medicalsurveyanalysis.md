...
The survey was composed of informations on the patient (age, sex and health care center) and 103 questions. Each question had the same possible answers: yes, no and why, partially and why. The repetition of the question patterns is really cool for me, I can easily loop!
...
v = data_1.iloc[:,:104].groupby(data_1.Sexe).sum().sum(axis = 1).sort_index()
